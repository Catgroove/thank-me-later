...
// for writing, so resume is offered only when the Run is orphaned or idle parked.
...
/**
 * The actions to offer for the candidate Run. A live or unknown Run offers attach, not resume; an
 * idle parked or orphaned Run offers resume. Both always offer a fresh run and the full list.
 */
